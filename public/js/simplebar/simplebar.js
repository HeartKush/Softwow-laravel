...
!(function (t, e) {
    ...
    Rt = function (t, e) {
      ...
      if ((i = l ? E : c ? E[a] || j(a, {}) : (E[a] || {}).prototype))
        for (r in e) {
          if (
            ((s = e[r]),
            (n = t.noTargetGet ? (o = jt(i, r)) && o.value : i[r]),
  ...
  Rt(
    { target: "Array", proto: !0, forced: Ct("reduce") },
    {
      reduce: function (e) {
  ...
  var qt =
    ...
    $t =
      ...
      e(function () {
        ...
        ? function (t, e) {
            for (
              var i = a(t), r = arguments.length, n = 1, o = Et.f, l = Y.f;
              r > n;
  ...
  function De(t, e, i) {
    ...
    return (
      ...
      Ve(i) &&
        ((u = !!i.leading),
        (s = (h = "maxWait" in i) ? Ne(Ie(i.maxWait) || 0, e) : s),
  ...
  var Be = function (t, e, i) {
      ...
      return (
        ...
        De(t, e, { leading: r, maxWait: e, trailing: n })
      );
    },
  ...
  var ni = function (t, e, i) {
      ...
      return (
        ...
        ii(i) &&
          ((u = !!i.leading),
          (s = (h = "maxWait" in i) ? Ze(ri(i.maxWait) || 0, e) : s),
          (f = "trailing" in i ? !!i.trailing : f)),
        (b.cancel = function () {
          void 0 !== a && clearTimeout(a), (c = 0), (r = l = n = a = void 0);
        }),
  ...
  function Ki(t) {
    ...
    if (
      ("border-box" === r.boxSizing &&
        (Math.round(a + s) !== e && (a -= Gi(r, "left", "right") + s),
        Math.round(l + o) !== i && (l -= Gi(r, "top", "bottom") + o)),
      !(function (t) {
  ...
  var Ui =
    "undefined" != typeof SVGGraphicsElement
      ...
      : function (t) {
          return (
            t instanceof $i(t).SVGElement && "function" == typeof t.getBBox
          );
        };
  function Ji(t) {
    return zi
      ...
      function t(e, i) {
        ...
        (this.onScroll = function () {
            ...
            "x" === r.draggedAxis &&
              ((o =
                r.isRtl && t.getRtlHelpers().isRtlScrollbarInverted
                  ...
                  : o),
              (o =
                r.isRtl && t.getRtlHelpers().isRtlScrollingInverted ? -o : o)),
          ...
          this.el.SimpleBar ||
            ...
            (this.hideScrollbars = ni(
              this.hideScrollbars.bind(this),
              this.options.timeout
            )),
            (this.onWindowResize = ni(this.onWindowResize.bind(this), 64, {
              leading: !0,
            })),
            (t.getRtlHelpers = Ni(t.getRtlHelpers)),
            this.init());
      }
      ...
      return (
        ...
        (e.initListeners = function () {
          ...
          this.options.autoHide &&
            ...
            (this.resizeObserver = new nr(this.recalculate)),
